...
// VERY OUTDATED FOOTER COMPONENT
      ...
      <footer className="bg-gray-50 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">ShopStyle</h3>
              <p className="text-gray-600">
                Modern fashion for the modern world. Designed with care and crafted with quality.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-600 hover:text-primary">Featured</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-600 hover:text-primary">Store Locations</a></li>
                <li><a href="#" className="text-gray-600 hover:text-primary">Our Story</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-600 hover:text-primary">Returns & Exchanges</a></li>
